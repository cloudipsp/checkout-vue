<template>
  <div v-if="show">
    ...
    <transition name="f-fade-enter">
      <click2pay-success-page-registration
...
import Click2paySuccessPageRegistration from '@/views/click2pay/success-page-registration'
...
export default {
  components: {
    Click2payHeader,
    FButton,
    Click2paySuccessPageRegistration,
    Click2payModalAbout,
  },
  data() {
    return {
